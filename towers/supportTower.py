...
range_imgs = [pygame.transform.scale(pygame.image.load(os.path.join("game_assets/towers", "4.png")).convert_alpha(), (90,90)),
              pygame.transform.scale(pygame.image.load(os.path.join("game_assets/towers", "5.png")).convert_alpha(), (90, 90))]
...
damage_imgs = [pygame.transform.scale(pygame.image.load(os.path.join("game_assets/towers", "8.png")).convert_alpha(), (90,90)),
              pygame.transform.scale(pygame.image.load(os.path.join("game_assets/towers", "9.png")).convert_alpha(), (90,90))]
